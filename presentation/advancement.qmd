...
(random feature latent variable model description)
...
# Methods 
1. Initialize latent space with fixed MAP estimate
2. HMC for functional bases.
3. Fix functional bases, HMC for latent space
...
1. Use model for causal effect of types of injuries across varying types of players. 
