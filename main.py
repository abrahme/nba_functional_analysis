...
if __name__ == "__main__":
    ...
    data["retirement"] = 1
    metric_output = ["binomial", "negative-binomial"] + (["gaussian"] * 2) + (["poisson"] * 9) + (["binomial"] * 3)
    ...
    if svi_inference:
        ...
        fig.write_image("model_output/model_plots/debug_predictions_svi_full_nb2_minutes.png", format = "png")
