...
mu_normalized = mu[2:]
core, factors = tucker(mu_normalized, rank= [14, X.shape[0], 3])
...
for pos in positions:
    ...
    pos_mu = mu[:, player_indices ,:][2:]
    core, factors = tucker(pos_mu,
                        rank = [14, X.shape[0], 3])
...
with ui.layout_column_wrap():
    ...
    def plot_metric_weights_bases_group():
        ...
        for pos in positions:
            ...
            weights_df = pd.DataFrame(weights, columns = metrics[2:])
